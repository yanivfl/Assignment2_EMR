...
//            extends Mapper<JoinApps.JoinableKey,InputFormats.TaggedValue,WritableComparable,InputFormats.TaggedValue> {
//        // The map gets a key and tagged value (of 2 types) and emits the key and the value
//        @Override
//        public void map(JoinableKey key, InputFormats.TaggedValue taggedValue, Context context) throws IOException,  InterruptedException {
//            context.write(key.getJoinKey(), taggedValue);
//        }
//    }
//
//
//    public static class ReduceClass  extends Reducer<WritableComparable,InputFormats.TaggedValue,Text,Text> {
//        @Override
//        public void reduce
//                (WritableComparable key,Iterable<InputFormats.TaggedValue> taggedValues, Context context) throws IOException, InterruptedException {
...
//            for (InputFormats.TaggedValue taggedValue : taggedValues) {
