...
//    public static class MapClass  extends Mapper<Text,InputFormats.TaggedValue<Text,Text>,Text,InputFormats.TaggedValue<Text,Text>> {
//        // The map gets a key and tagged value (of 2 types) and emits the key and the value
//        @Override
//        public void map(Text key, InputFormats.TaggedValue<Text,Text> value, Context context) throws IOException,  InterruptedException {
//            context.write(key, value);
//        }
//    }
//
//
//    public static class ReduceClass  extends Reducer<Text,InputFormats.TaggedValue<Text,Text>,Text,Text> {
//        @Override
//        public void reduce(Text key, Iterable<InputFormats.TaggedValue<Text,Text>> taggedValues, Context context) throws IOException, InterruptedException {
...
//            for (InputFormats.TaggedValue<Text,Text> taggedValue : taggedValues) {
